...
class App extends Component {
    ...
    handleResponse =async () => {
        ...
        var visitors;
        var newVisitors;
        // let ref = fire.database().ref("visitors")
      ...
      <div className="demo-big-content">
        <Layout >
            ...
            <Drawer title="Menu" className="drawer">
                <Navigation>
                    <Link to="/" onClick={() => this.hideToggle()}>Početna</Link>
                    <Link to="/resume" onClick={() => this.hideToggle()}>Životopis</Link>
                    <Link to="/projects" onClick={() => this.hideToggle()}>Projekti</Link>
                    <Link to="/contact" onClick={() => this.hideToggle()}>Kontakt</Link>
                    <Link to="/contact" onClick={() => this.hideToggle()}>Kontakt</Link>
                </Navigation>
            </Drawer>
            <Content>
