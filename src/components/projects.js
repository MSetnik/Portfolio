        ...
        if(this.state.activeTab === 0) {
            ...
            return (
                <div className="projects-grid">
                    ...
                    {/* project 2 */}
                    <Card className="projects-card" shadow={5} style={{minWidth: '450' , margin:'auto'}}>
                        <CardTitle style={{color: '#000', height: '120px', background: 'url(https://skywell.software/wp-content/uploads/2019/01/javascript-vs-html-vs-css-1024x683.jpg) center / cover'}}>
