        ...
        if(this.state.activeTab === 0) {
            return (
                <div className="projects-grid">
                    ...
                    <Card className="projects-card" shadow={5} style={{minWidth: '450'}}>
                        <CardTitle style={{color: '#000', height: '176px', background: 'url(https://lh3.googleusercontent.com/GTmuiIZrppouc6hhdWiocybtRx1Tpbl52eYw4l-nAqHtHd4BpSMEqe-vGv7ZFiaHhG_l4v2m5Fdhapxw9aFLf28ErztHEv5WYIz5fA) center / cover'}}>
                    ...
                    {/* project 2 */}
                    <Card className="projects-card" shadow={5} style={{minWidth: '450' , margin:'auto', display:'flex'}}>
                        <CardTitle style={{color: '#000', height: '176px', background: 'url(https://lh3.googleusercontent.com/GTmuiIZrppouc6hhdWiocybtRx1Tpbl52eYw4l-nAqHtHd4BpSMEqe-vGv7ZFiaHhG_l4v2m5Fdhapxw9aFLf28ErztHEv5WYIz5fA) center / cover'}}>
                            VSMTI Info
                        </CardTitle>
            ...
            return (
                <div className="projects-grid">
                     {/* project 1 */}
                    <Card className="projects-card" shadow={5} style={{minWidth: '450' , margin:'auto'}}>
                        <CardTitle style={{color: '#000', height: '176px', background: 'url(https://skywell.software/wp-content/uploads/2019/01/javascript-vs-html-vs-css-1024x683.jpg) center / cover'}}>
                    ...
                    <Card className="projects-card" shadow={5} style={{minWidth: '450' , margin:'auto'}}>
                        ...
                        <CardText>
                            Web aplikacija koja služi za administraciju hotela. Aplikacija ima mogućnost pregleda hotela na području Hrvatske
                            te mogućnost dodavanja novih. Također je moguće rezervirati smještaj te pregledati kapacitet, odnosno popunjenost
                            hotela. Hotele je moguće prikazati na google karti. Kao baza je korišten firebase.
                        </CardText>
                        <CardActions border>
                            <Button colored><a href="https://github.com/MSetnik/CityInfrastructureManager" target="_blank">Github</a></Button>
                        </CardActions>
