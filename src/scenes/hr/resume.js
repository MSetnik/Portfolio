			...
			<Grid>
				<Cell className="resume-left-col" col={6}>
					...
					>
						...
						<p>
							...
							te sam završio preddiplomski stručni studij
							Računarstva, smjera Programsko inženjerstvo u
							Virovitici. <br />
							Radim kao Specijalist u službi razvoja aplikativnih
							rješenja u mStart plus d.o.o. <br />
							na poziciji React Native developera. <br />
							U svom profesionalnom iskustvu izradio sam 4 interne
							aplikacije <br />i 2 aplikacije za klijente tvrtke.
				...
				<Cell className="resume-right-col" col={6}>
					...
					<div data-aos="zoom-out" data-aos-anchor="#startAnim">
						...
						<Experience
							startYear="12/04/2023"
							endYear="Danas"
							jobName="Vlasnik obrta"
							companyName="MCODE, obrt za računalno programiranje"
							jobPlace="Valpovo, Hrvatska"
							jobDescription={
						...
						<Experience
							...
							endYear="Danas"
							jobName="Specijalist u Službi razvoja aplikativnih rješenja"
